...
const Navbar = () => {
    ...
    const isShopPage = location.pathname === '/collection';
  return (
    <div className='flex items-center justify-between py-5 font-medium'>
        <Link to='/'><img src={assets.logo} className='w-40' alt='logo'/></Link>

        <ul className='hidden sm:flex gap-5 text-sm text-blue-900'>
          <NavLink to='/' className='flex flex-col items-center gap-1'>
            <p>HOME</p>
            <hr className='w-2/4 border-none h-[1.5px] bg-blue-900 hidden'/>
          </NavLink>
        ...
        <div className='flex items-center gap-6'>
            ...
            <div className='group relative z-50'>
              ...
              <div className='group-hover:block hidden absolute dropdown-menu right-0 pt-4'>
                  <div className='flex flex-col gap-2 w-36 py-3 px-5 bg-slate-100 text-blue-800 rounded'>
            ...
            <Link to='/cart' className='relative'>
                ...
                <p className='absolute right-[-5px] bottom-[-5px] w-4 text-center leading-4 bg-blue-950 text-white aspect-square rounded-full text-[9px]'>{getCartCount()}</p>
            </Link>
